...
public class SimpleMailMessageTests {
	...
	@Test
	public void testDeepCopyOfStringArrayTypedFieldsOnCopyCtor() {
	...
	public void testCopyCtorChokesOnNullOriginalMessage() {
		new SimpleMailMessage(null);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testCopyToChokesOnNullTargetMessage() {
