...
public class WebContentGeneratorTests {
	...
	@Test
	public void getAllowHeaderWithConstructorTrue() {
	...
	@Test
	public void getAllowHeaderWithConstructorFalse() {
	...
	@Test
	public void getAllowHeaderWithSupportedMethodsSetterEmpty() {
		WebContentGenerator generator = new TestWebContentGenerator();
	...
	@Test
	public void varyHeaderWithExistingWildcard() {
	...
	@Test
	public void varyHeaderWithExistingCommaValues() {
		String[] configuredValues = {"Accept-Language", "User-Agent"};
	...
	@Test
	public void varyHeaderWithExistingCommaSeparatedValues() {
		String[] configuredValues = {"Accept-Language", "User-Agent"};
		String[] responseValues = {"Accept-Encoding, Accept-Language"};
		String[] expected = {"Accept-Encoding, Accept-Language", "User-Agent"};
		testVaryHeader(configuredValues, responseValues, expected);
