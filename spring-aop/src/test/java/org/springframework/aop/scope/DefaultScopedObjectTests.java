...
public class DefaultScopedObjectTests {
	...
	public void testCtorWithNullBeanFactory() {
		new DefaultScopedObject(null, GOOD_BEAN_NAME);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testCtorWithNullTargetBeanName() {
		testBadTargetBeanName(null);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testCtorWithEmptyTargetBeanName() {
		testBadTargetBeanName("");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testCtorWithJustWhitespacedTargetBeanName() {
		testBadTargetBeanName("   ");
	}
