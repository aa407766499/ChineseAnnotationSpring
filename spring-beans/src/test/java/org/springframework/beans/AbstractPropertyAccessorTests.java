...
public abstract class AbstractPropertyAccessorTests {
	...
	@Test
	public void setNestedPropertyPolymorphic() {
		ITestBean target = new TestBean("rod", 31);
	...
	@Test
	public void setAnotherNestedProperty() {
		ITestBean target = new TestBean("rod", 31);
	...
	@Test
	public void setAnotherPropertyIntermediatePropertyIsNull() {
		ITestBean target = new TestBean("rod", 31);
		AbstractPropertyAccessor accessor = createAccessor(target);
		try {
	...
	@Test
	public void setPropertiesProperty() {
	...
	@Test
	public void setStringArrayProperty() {
		PropsTester target = new PropsTester();
		AbstractPropertyAccessor accessor = createAccessor(target);
	...
	@Test
	public void setStringArrayPropertyWithCustomStringEditor() {
		PropsTester target = new PropsTester();
		AbstractPropertyAccessor accessor = createAccessor(target);
	...
	@Test
	public void setStringArrayPropertyWithStringSplitting() {
		PropsTester target = new PropsTester();
		AbstractPropertyAccessor accessor = createAccessor(target);
	...
	@Test
	public void setStringArrayPropertyWithCustomStringDelimiter() {
		PropsTester target = new PropsTester();
		AbstractPropertyAccessor accessor = createAccessor(target);
	...
	@Test
	public void setStringArrayWithAutoGrow() {
	...
	@Test
	public void setIntArrayPropertyWithStringSplitting() {
		PropsTester target = new PropsTester();
		AbstractPropertyAccessor accessor = createAccessor(target);
		accessor.useConfigValueEditors();
	...
	@Test
	public void setPrimitiveArrayPropertyWithAutoGrow() {
		PrimitiveArrayBean target = new PrimitiveArrayBean();
		AbstractPropertyAccessor accessor = createAccessor(target);
		accessor.setAutoGrowNestedPaths(true);
