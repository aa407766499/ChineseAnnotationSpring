...
public class CollectionsWithDefaultTypesTests {
	...
	@Test
	public void testListHasDefaultType() {
	...
	@Test
	public void testSetHasDefaultType() {
		TestBean bean = (TestBean) this.beanFactory.getBean("testBean");
	...
	@Test
	public void testMapHasDefaultKeyAndValueType() {
		TestBean bean = (TestBean) this.beanFactory.getBean("testBean");
		assertMap(bean.getSomeMap());
	}

	@Test
	public void testMapWithNestedElementsHasDefaultKeyAndValueType() {
