...
//		ctx.refresh();
	...
	public void testNoServiceLocatorInterfaceSupplied() {
		new ServiceLocatorFactoryBean().afterPropertiesSet();
	}

	@Test(expected = IllegalArgumentException.class)
	public void testWhenServiceLocatorInterfaceIsNotAnInterfaceType() {
	...
	public void testWhenServiceLocatorMethodCalledWithTooManyParameters() {
		ServiceLocatorFactoryBean factory = new ServiceLocatorFactoryBean();
	...
	@Test
	public void testRequiresListableBeanFactoryAndChokesOnAnythingElse() {
