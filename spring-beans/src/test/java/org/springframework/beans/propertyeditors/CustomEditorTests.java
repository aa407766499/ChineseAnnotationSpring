...
public class CustomEditorTests {
	...
	@Test
	public void testCustomBooleanEditorWithSpecialTrueAndFalseStrings() {
	...
	@Test
	public void testCustomNumberEditorWithFrenchBigDecimal() {
	...
	public void testCharacterEditorSetAsTextWithStringLongerThanOneCharacter() {
		PropertyEditor charEditor = new CharacterEditor(false);
		charEditor.setAsText("ColdWaterCanyon");
	}

	@Test
	public void testCharacterEditorGetAsTextReturnsEmptyStringIfValueIsNull() {
		PropertyEditor charEditor = new CharacterEditor(false);
	...
	@Test(expected = IllegalArgumentException.class)
	public void testCharacterEditorSetAsTextWithNullNotAllowingEmptyAsNull() {
		PropertyEditor charEditor = new CharacterEditor(false);
		charEditor.setAsText(null);
	}
	...
	@Test(expected = IllegalArgumentException.class)
	public void testClassEditorWithNonExistentClass() {
		PropertyEditor classEditor = new ClassEditor();
	...
	*/
	@Test
	public void testGetAsTextWithTwoDimensionalArray() {
	 ...
	 */
	@Test
	public void testGetAsTextWithRidiculousMultiDimensionalArray() {
	...
	@Test
	public void testConversionToOldCollections() {
	...
	@Test
	public void testArrayToStringConversion() {
		TestBean tb = new TestBean();
		BeanWrapper bw = new BeanWrapperImpl(tb);
		bw.registerCustomEditor(String.class, new PropertyEditorSupport() {
			@Override
	...
	@Test
	public void testClassArrayEditorSunnyDay() {
	...
	@Test
	public void testClassArrayEditorSunnyDayWithArrayTypes() {
		ClassArrayEditor classArrayEditor = new ClassArrayEditor();
	...
	@Test
	public void testClassArrayEditorSetAsTextWithNull() {
	...
	@Test
	public void testClassArrayEditorSetAsTextWithEmptyString() {
		ClassArrayEditor editor = new ClassArrayEditor();
		editor.setAsText("");
		assertNull(editor.getValue());
		assertEquals("", editor.getAsText());
	...
	@Test
	public void testClassArrayEditorSetAsTextWithWhitespaceString() {
		ClassArrayEditor editor = new ClassArrayEditor();
		editor.setAsText("\n");
		assertNull(editor.getValue());
		assertEquals("", editor.getAsText());
