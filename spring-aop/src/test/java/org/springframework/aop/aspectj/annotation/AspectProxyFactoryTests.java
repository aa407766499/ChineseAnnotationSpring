...
public class AspectProxyFactoryTests {
	...
	@Test
	public void testWithSimpleAspect() {
	...
	@Test
	public void testWithPerThisAspect() {
	...
	@Test(expected = IllegalArgumentException.class)
	public void testWithInstanceWithNonAspect() {
	...
	@Test(expected = IllegalArgumentException.class)
	public void testWithNonSingletonAspectInstance() {
		AspectJProxyFactory pf = new AspectJProxyFactory();
