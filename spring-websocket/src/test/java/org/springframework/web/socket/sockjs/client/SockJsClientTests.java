...
public class SockJsClientTests {
	...
	@Test
	public void connectWebSocketDisabled() {
	...
	@Test
	public void connectXhrStreamingDisabled() {
		setupInfoRequest(false);
	...
	@Test
	public void connectSockJsInfoCached() {
		setupInfoRequest(true);
		this.sockJsClient.doHandshake(handler, URL);
		this.sockJsClient.doHandshake(handler, URL);
		this.sockJsClient.doHandshake(handler, URL);
	...
	@Test
	public void connectInfoRequestFailure() {
