...
public class DefaultSockJsServiceTests extends AbstractHttpRequestTests {
	...
	@Test
	public void handleTransportRequestXhr() {
	...
	@Test  // SPR-12226
	public void handleTransportRequestXhrAllowedOriginsMatch() {
		String sockJsPath = sessionUrlPrefix + "xhr";
		setRequest("POST", sockJsPrefix + sockJsPath);
	...
	@Test  // SPR-12226
	public void handleTransportRequestXhrAllowedOriginsNoMatch() {
		String sockJsPath = sessionUrlPrefix + "xhr";
		setRequest("POST", sockJsPrefix + sockJsPath);
		this.service.setAllowedOrigins(Arrays.asList("http://mydomain1.com", "http://mydomain2.com"));
	...
	@Test  // SPR-13464
	public void handleTransportRequestXhrSameOrigin() {
		String sockJsPath = sessionUrlPrefix + "xhr";
		setRequest("POST", sockJsPrefix + sockJsPath);
	...
	@Test  // SPR-13545
	public void handleInvalidTransportType() {
	...
	@Test
	public void handleTransportRequestXhrOptions() {
		String sockJsPath = sessionUrlPrefix + "xhr";
	...
	@Test
	public void handleTransportRequestNoSuitableHandler() {
	...
	@Test
	public void handleTransportRequestXhrSend() {
	...
	@Test
	public void handleTransportRequestXhrSendWithDifferentUser() {
		String sockJsPath = sessionUrlPrefix + "xhr";
		setRequest("POST", sockJsPrefix + sockJsPath);
		this.service.handleRequest(this.request, this.response, sockJsPath, this.wsHandler);
	...
	@Test
	 public void handleTransportRequestJsonp() {
	...
	@Test
	public void handleTransportRequestWebsocket() {
	...
	@Test
	public void handleTransportRequestIframe() {
